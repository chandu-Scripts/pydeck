            ...
            >
              ...
              <button
                onClick={async () => {
                  ...
                  // on success: browser redirects, so no need to setLoading(false)
                }}
                disabled={googleLoading}
                className="w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-white text-gray-800 rounded-xl font-medium hover:bg-gray-100 transition-colors cursor-pointer disabled:opacity-60"
              >
                {googleLoading
